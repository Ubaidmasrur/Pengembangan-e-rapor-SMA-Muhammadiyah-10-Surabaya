...
<?php $component->withAttributes([]); ?>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-6" data-bulk-url="<?php echo e(route('grades.bulkStore')); ?>">
            ...
            <?php if($errors->any()): ?>
                            ...
                            <?php if(!empty($academicYears)): ?>
                                <?php $__currentLoopData = $academicYears; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($year->id); ?>"
                                        data-start_month="<?php echo e($year->start_month ?? ''); ?>"
                                        data-end_month="<?php echo e($year->end_month ?? ''); ?>"
                                        <?php echo e(request('academic_year_id') == $year->id ? 'selected' : ''); ?>>
                                        <?php echo e($year->year ?? '-'); ?> - <?php echo e($year->semester ?? '-'); ?>
                        ...
                        <select name="student_id" id="student_id"
                            ...
                            <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($student->student_id); ?>"
                                    <?php echo e(request('student_id') == $student->student_id ? 'selected' : ''); ?>>
                ...
                <div class="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input id="master_motorik" name="master_motorik" type="number" step="0.01" min="0"
                            ...
                            value="<?php echo e(old('master_motorik') ?? (request('master_motorik') ?? '')); ?>">
                    </div>
                    <div>
                        ...
                        <input id="master_kognitif" name="master_kognitif" type="number" step="0.01" min="0"
                            max="100" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm"
                            value="<?php echo e(old('master_kognitif') ?? (request('master_kognitif') ?? '')); ?>">
                    </div>
                    <div>
                        ...
                        <input id="master_sosial" name="master_sosial" type="number" step="0.01" min="0"
                            max="100" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm"
                            value="<?php echo e(old('master_sosial') ?? (request('master_sosial') ?? '')); ?>">
                    </div>
                </div>
                ...
                <div class="mt-4">
                    ...
                    <textarea id="master_note" name="master_note" rows="3"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" placeholder="Catatan perkembangan siswa"><?php echo e(old('master_note') ?? (request('master_note') ?? '')); ?></textarea>
                </div>
...
<?php endif; ?>
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody id="detailBody" class="bg-white divide-y divide-gray-200">
                            <?php if(isset($grades) && $grades instanceof \Illuminate\Contracts\Pagination\LengthAwarePaginator && $grades->count()): ?>
                                <?php $__currentLoopData = $grades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr data-subject-id="<?php echo e($g->subject_id); ?>">
                                            <td class="px-6 py-4 text-sm text-gray-700"><?php echo e($g->subject_name ?? '-'); ?></td>
                                            <td class="px-6 py-4 text-sm text-gray-700"><?php echo e($g->score ?? '-'); ?></td>
                                            <td class="px-6 py-4 text-sm text-gray-700"><?php echo e($g->grade_letter ?? '-'); ?></td>
                                            <td class="px-6 py-4 text-sm text-gray-700"><?php echo e($g->notes ?? '-'); ?></td>
                                            <td class="px-6 py-4 text-sm text-gray-700"><?php echo e($g->fase ?? '-'); ?></td>
                                            <td class="px-6 py-4 text-sm text-gray-700">
                                                <button type="button" class="edit-saved text-indigo-600 mr-2" data-id="<?php echo e($g->id); ?>">Edit</button>
                                                <button type="button" class="remove-saved text-red-600" data-id="<?php echo e($g->id); ?>">Remove</button>
                                            </td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php else: ?>
                ...
                <div class="mt-4 flex items-center justify-between">
                    <div>
                        <?php if(isset($grades) && $grades instanceof \Illuminate\Contracts\Pagination\LengthAwarePaginator && $grades->count()): ?>
                            <?php echo e($grades->withQueryString()->links()); ?>
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', function() {
                        ...
                        if (addGradeForm) {
                            ...
                            if (modalScoreInput && modalGradeInput) {
                                modalScoreInput.addEventListener('input', function(e) {
                                    ...
                                    var url = '<?php echo e(route('ajax.grade_parameters.lookup')); ?>' + '?score=' +
                        ...
                        function submitPendingGrades() {
                            ...
                            var url = '<?php echo e(route('grades.bulkStore')); ?>';
                            clearError();
                            if (saveAllBtn) {
                        ...
                        function fetchAndPopulateMaster() {
                            ...
                            var url = '<?php echo e(route('guru.grading.getMasterRecord')); ?>' + '?student_id=' + encodeURIComponent(s) +
                        ...
                        function fetchGrades() {
                            ...
                            var y = yearSelect ? yearSelect.value : '';
                            if (!s || !c || !y) return;
                            var url = '<?php echo e(route('guru.grading.getGrades')); ?>' + '?student_id=' + encodeURIComponent(s) +
                                '&class_id=' + encodeURIComponent(c) + '&academic_year_id=' + encodeURIComponent(y);
                            try {
                        ...
                        if (detailBody) {
                            detailBody.addEventListener('click', function(e) {
                                ...
                                if (t.matches('.edit-pending')) {
                                    ...
                                    if (gradeEl) {
                                        var lookupUrl = '<?php echo e(route('ajax.grade_parameters.lookup')); ?>' + '?score=' + encodeURIComponent(item.score || '');
                                        var spinner = addGradeForm.querySelector('.grade-letter-spinner');
                                        if (spinner) spinner.classList.remove('hidden');
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['name' => 'add-grade-modal','focusable' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'add-grade-modal','focusable' => true]); ?>
                <form id="addGradeForm" method="POST" action="<?php echo e(route('grades.store')); ?>" class="p-6">
                    <?php echo csrf_field(); ?>
                    <h3 class="text-lg font-medium">Add Grade</h3>

                    <div id="addGradeErrors" class="mb-4"></div>

                    <input type="hidden" name="student_id" value="<?php echo e(optional($selectedStudent)->id ?? ''); ?>">
                    <input type="hidden" name="class_id"
                        value="<?php echo e(optional($selectedClass)->id ?? (request('class_id') ?? '')); ?>">
                    <input type="hidden" name="academic_year_id"
                        value="<?php echo e(optional($selectedAcademicYear)->id ?? (request('academic_year_id') ?? '')); ?>">
...
<?php endif; ?>
<?php /**PATH D:\Priv\Project\erapor\e-rapor-sederhana\resources\views/guru/grade/studentgrades.blade.php ENDPATH**/ ?>